...
welcomeHeading.innerHTML = `Write your plans
 ${sharedName}`;
...
async function getTodosFromDatabase() {
    const apiUrl = `https://656951d1de53105b0dd6e610.mockapi.io/user/${sharedVariable}/ToDo`;
...
async function updateTodoStatusInDatabase(todoId, completedStatus) {
  const apiUrl = `https://656951d1de53105b0dd6e610.mockapi.io/user/${sharedVariable}/ToDo/${todoId}`;
